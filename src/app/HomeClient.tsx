...
const channels = [
  ...
  { label: "Applications", icon: PackageSearch },
...
function Navigation() {
  ...
  const links = [["#platform", "Platform"], ["#experiences", "Sites & apps"], ["#mobile", "Mobile"], ["#proof", "Why OneApp"], ["#webaholics", "Managed growth"]];
  return (
    ...
    <section className="relative overflow-hidden border-b border-white/[0.06] bg-[#0b0a10] pt-20">
      ...
      <div className="relative mx-auto grid min-h-[850px] max-w-[1380px] items-center gap-16 px-5 py-20 sm:px-8 lg:grid-cols-[.92fr_1.08fr] lg:py-24">
        <div>
          ...
          <motion.p initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .16 }} className="mt-8 max-w-[650px] text-lg leading-relaxed text-white/55 sm:text-xl">Power your sites, storefronts and custom applications with one connected business platform. Give your team and AI the context and tools to turn customer intent into completed work.</motion.p>
...
function ConnectedExperiences() {
  const experiences = [
    ...
    {number: "03", name: "Applications that move work forward.", tag: "SERVE & RETAIN", text: "Build custom applications for learning, subscriptions or specialized business workflows. Connect users, records and actions to the rest of your operation.", icon: Users, items: ["Customer request", "Team approval", "Recorded outcome"]},
  ];
